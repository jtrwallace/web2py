...
def index():
    ...
    for email in email_list:
        email['pretty_date'] = pretty_date(email['date'])
...
def pretty_date(date):
    ...
    pretty = calendar.month_name[dt.month] + " " + str(dt.day) + ", " + str(dt.year) + " " + str(dt.time())
    return {'day': dt.day, 'month': month, 'pretty': pretty}